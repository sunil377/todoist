        ...
        <Fragment>
            ...
            >
                ...
                >
                    ...
                    <Dialog.Panel className="relative z-20 h-auto max-h-[calc(100vh-2*2.24rem)] w-full max-w-[calc(100%-2*2.24rem)] overflow-auto rounded-md border border-gray-800 bg-gray-800 p-5 shadow-md shadow-gray-800 sm:max-w-[min(700px,calc(100%-2*2.4rem))] sm:p-10">
                        <Dialog.Title
                            as="h4"
